...
package com.binvi.springboot.demo03.jaxws;
...
public class JaxWsSupportTests {
	...
	private void doTestJaxWsPortAccess(WebServiceFeature... features) throws Exception {
		...
		clientDef.getPropertyValues().add("namespaceUri", "http://jaxws.demo03.springboot.binvi.com/");
		...
		serviceFactoryDef.getPropertyValues().add("namespaceUri", "http://jaxws.demo03.springboot.binvi.com/");
	...
	@WebServiceClient(targetNamespace = "http://jaxws.demo03.springboot.binvi.com/", name="OrderService")
	public static class OrderServiceService extends Service {
		...
		public OrderServiceService() throws MalformedURLException {
			super(new URL("http://localhost:9999/OrderService?wsdl"),
					new QName("http://jaxws.demo03.springboot.binvi.com/", "OrderService"));
		}
